      ...
      >
        ...
        >
          ...
          <div className='flex items-center justify-center gap-2'>
            ...
            <Link
              to='/login'
              className='capitalize text-xl px-2 py-1 text-gray-700  mr-2 bg-yellow-300 hover:bg-yellow-400 rounded'
            >
          ...
          <div className='mt-4 flex items-center justify-center gap-2'>
            ...
            <Link
              to='/register'
              className='capitalize text-xl bg-blue-500 hover:bg-blue-700 text-white font-bold px-2 py-1 rounded'
            >
